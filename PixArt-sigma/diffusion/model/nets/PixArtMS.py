...
class PixArtMS(PixArt):
    ...
    def forward_with_dpmsolver(self, x, timestep, y, data_info, input_latent=None, **kwargs):
        """
        ...
        model_out = self.forward(x, timestep, y, data_info=data_info, input_latent=input_latent, **kwargs)
